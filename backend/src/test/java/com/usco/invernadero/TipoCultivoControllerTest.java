...
public class TipoCultivoControllerTest {
    ...
    void getAll_TipoCultivo_shouldReturn200() throws Exception {
        mockMvc.perform(get("/api/tipo-cultivos")
    ...
    @Test
    @WithMockUser(username = "test@example.com", roles = "USER")
    void getById_TipoCultivo_notFound_shouldReturn404() throws Exception {
        mockMvc.perform(get("/api/tipo-cultivos/999999"))
